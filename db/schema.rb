...
ActiveRecord::Schema[7.0].define(version: 2023_10_25_125539) do
  ...
  create_table "character_actions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["action_id"], name: "index_character_actions_on_action_id"
  ...
  add_foreign_key "character_actions", "actions"
